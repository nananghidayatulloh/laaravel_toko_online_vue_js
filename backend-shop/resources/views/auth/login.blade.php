         ...
         <div class="card o-hidden border-0 shadow-lg mb-3 mt-5">
            <div class="card-body p-4">
               ...
               <div class="text-center">
                  <h1 class="h5 text-gray-900 mb-3">LOGIN
                     ADMIN
                  </h1>
               </div>
               <form action="{{ route('login') }}"
                  ...
                  <div class="form-group">
                     ...
                     <input type="email" name="email"
                        value="{{ old('email') }}" class="form-control @error('email') isinvalid @enderror" placeholder="Masukkan Alamat Email">
                     @error('email')
                  ...
                  <hr>
                  <a href="/forgot-password">Lupa Password
                  ?</a>
               </form>
            </div>
         </div>
